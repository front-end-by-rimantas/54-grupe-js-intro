...
// Masyvas, kuriame nera didziausio skaiciaus
{
    ...
    console.assert(didziausiasSkaiciusSarase([true]) === 'Pateiktas sąrašas negali būti tuščias.', 'Tuscias masyvas');
    console.assert(didziausiasSkaiciusSarase([true, 5]) === 5, 'Didziausia reiksme: 5');
}
